		...
		<header>
			<div class="container">
				<div class="row">
					<div class="col-xs-5">
						<div class="logo">
							<h1><img alt="" src="resources/images/logo.png"></h1>
						</div>
					</div>
						...
						<div class="page-content row">
							<form class="form-horizontal" id="form-change-password" action="setting" style="margin-top:40px;" method="post">
									...
									<div class="form-group form-job-type">
										<label class="control-label col-md-2" for="password">考试科目</label>
										<div class="col-md-5">
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<div class="copy">
							<p>
								云南大学在线考试平台 Copyright © 2018 Yunnan University Incorporated. All rights reserved.
							</p>
							<p>
								Email: pxy01234@qq.com | Phone: 18468275528
							</p>
						</div>
					</div>
				</div>
